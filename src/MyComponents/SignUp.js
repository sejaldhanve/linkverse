...
import LinkVerseimg from './Linkverse.jpg'
import "./SignUp.css";
...
const SignUp = () => {
  ...
  return (
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
      <div class="border border-sky-500 relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
        <div class="max-w-md mx-auto">
          ...
          <div className="flex items-center space-x-5 justify-center"><img src={LinkVerseimg} height={200} width={200} alt="LinkVerse"/></div>
          <div class="mt-5">
            <label
          ...
          <div class="flex justify-center w-full items-center">
            <div>
              <button onClick={handleGoogle} class="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
                <svg
                  viewBox="0 0 24 24"
                  height="25"
                  width="25"
